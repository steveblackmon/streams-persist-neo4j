 ...
 */
public class TestNeo4jBinaryPersistWriteActivityObjects {

    private final static Logger LOGGER = LoggerFactory.getLogger(TestNeo4jBinaryPersistWriteActivityObjects.class);

    private final static ObjectMapper mapper = StreamsJacksonMapper.getInstance();

    private final String testGraphFile = "target/activityobjects.neo4j";
    ...
    @Test
    public void testNeo4jBinaryPersistWriteActivityObjects() throws Exception {

        InputStream testActivityFolderStream = TestNeo4jBinaryPersistWriteActivityObjects.class.getClassLoader()
                .getResourceAsStream("activities");
        List<String> files = IOUtils.readLines(testActivityFolderStream, Charsets.UTF_8);

        for (String file : files) {
            LOGGER.info("File: " + file);
            InputStream testActivityFileStream = TestNeo4jBinaryPersistWriteActivityObjects.class.getClassLoader()
